	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li class="fh5co-active"><a href="edm.php">*Email*</a></li>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Complete the fields below and submit, to generate your custom email.</h2>
				<div class="row">
					<div class="col-md-1">
...
<input type="hidden" name="tab" value="1">
                ...
                <!-- header colour --> 
                 <div class="form-group">
                    <input class="form-control" name="head2" type="text" placeholder="header colour" ></p>
                </div> 
                <!-- head1  -->
                <div class="form-group">
                ...
                <!-- head1Colour -->
                <div class="form-group">
                <input class="form-control" name="head1Colour" type="text" label="123" placeholder="headline colour" ></p>
                </div>
                ...
                <!-- ctaColour make this manually white 
                <div class="form-group">
