	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Industry Pages</h2>
				<div class="row row-bottom-padded-md">
					...
					<div class="col-md-5 col-padding animate-box" data-animate-effect="fadeInLeft">
						<div class="blog-entry">
							...
							<div class="desc">
								<h3><a href="#">Northern Trail Outfitters - Retail</a></h3>
								<span><small></small></span>
								<p>Design must be functional and functionality must be translated into visual aesthetics</p>
								<table style="width:100%; text-align: center;">

								<a>  <tr><th><a href="industry1.php" class="lead">Download <i class="icon-arrow-right3"></i></a></th><th><a href="#" class="lead">Customise <i class="icon-arrow-right3"></i></a></th></tr></table> </a>
							</div>
						</div>
					</div>
					<div class="col-md-5 col-padding animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="blog-entry">
							<a href="#" class="blog-img"> <img src="https://s3-us-west-2.amazonaws.com/rd-industry-assets/cloudpages-industry-logos/fins-cumulus-logo.png" style="max-height: 80px; text-align:center" class="img-responsive"></a>
							<div class="desc">
								<h3><a href="#">Cumulus - Fins</a></h3>
								<span><small></small></span>
								<p>Design must be functional and functionality must be translated into visual aesthetics</p>
								<table style="width:100%; text-align: center;">

								<a>  <tr><th><a href="industry2.php" class="lead">Download <i class="icon-arrow-right3"></i></a></th><th><a href="#" class="lead">Customise <i class="icon-arrow-right3"></i></a></th></tr></table> </a>
							</div>
						</div>
					</div>
					<div class="col-md-1 col-padding animate-box" data-animate-effect="fadeInLeft">
			...
			<div class="row row-bottom-padded-md">
					...
					<div class="col-md-5 col-padding animate-box" data-animate-effect="fadeInLeft">
						<div class="blog-entry">
							...
							<div class="desc">
								<h3><a href="#">Makana Health - Health</a></h3>
								<span><small></small></span>
								<p>Design must be functional and functionality must be translated into visual aesthetics</p>
								<table style="width:100%; text-align: center;">

								<a>  <tr><th><a href="industry3.php" class="lead">Download <i class="icon-arrow-right3"></i></a></th><th><a href="#" class="lead">Customise <i class="icon-arrow-right3"></i></a></th></tr></table> </a>
							</div>
						</div>
					</div>
					<div class="col-md-5 col-padding animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="blog-entry">
							<a href="#" class="blog-img"><img src="https://s3-us-west-2.amazonaws.com/rd-industry-assets/cloudpages-industry-logos/travel-palonia-logo.png" style="max-height: 80px; text-align:center" class="img-responsive"></a>
							<div class="desc">
								<h3><a href="#">Palonia - Loyalty</a></h3>
								<span><small></small></span>
								<p>Design must be functional and functionality must be translated into visual aesthetics</p>
								<table style="width:100%; text-align: center;">

								<a>  <tr><th><a href="industry4.php" class="lead">Download <i class="icon-arrow-right3"></i></a></th><th><a href="#" class="lead">Customise <i class="icon-arrow-right3"></i></a></th></tr></table> </a>
							</div>
						</div>
					</div>
					<div class="col-md-1 col-padding animate-box" data-animate-effect="fadeInLeft">
					...
					<div class="col-md-5 col-padding animate-box" data-animate-effect="fadeInLeft">
						<div class="blog-entry">
							...
							<div class="desc">
								...
								<a>  <tr><th><a href="#" class="lead">Download <i class="icon-arrow-right3"></i></a></th><th><a href="#" class="lead">Customise <i class="icon-arrow-right3"></i></a></th></tr></table> </a>
							</div>
						</div>
					</div>
					<div class="col-md-5 col-padding animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="blog-entry">
							...
							<div class="desc">
								...
								<a>  <tr><th><a href="http://localhost:8888/cody4/marble2/industry1.php" class="lead">Download <i class="icon-arrow-right3"></i></a></th><th><a href="#" class="lead">Customise <i class="icon-arrow-right3"></i></a></th></tr></table> </a>
							</div>
						</div>
					</div>
					<div class="col-md-1 col-padding animate-box" data-animate-effect="fadeInLeft">
