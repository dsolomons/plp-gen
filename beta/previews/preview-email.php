                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                      <tr>
                          ...
                          <td align="center" style="font-family: Open Sans, Helvetica, Arial, sans-serif;" class=""><h1 style="font-size: 40px; color: <?php echo $head1Colour ?>; margin: 0; padding-bottom: 10px;"><?php  echo $head1;?><br><br></h1>
